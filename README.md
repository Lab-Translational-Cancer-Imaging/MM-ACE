...
## Customizability
The folder `MedicalDataAugmentationTool` contains the original code from Payer et al. ([Coarse to Fine Vertebrae Localization and Segmentation with SpatialConfiguration-Net and U-Net](https://doi.org/10.5220/0008975201240133)) with the additions. If you want to change the singularity container. Edit your wanted file and copy it into the correct location inside the singularity shell.
